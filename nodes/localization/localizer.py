...
class Localizer:
    ...
    def transform_coordinates(self, msg):
        ...
        _msg.twist.linear.x = norm
        self.current_velocity_pub.publish(_msg)
        ...
        _msg.transform.translation.x = x
        _msg.transform.translation.y = y
        _msg.transform.translation.z = z
        _msg.transform.rotation = orientation
        

        self.br.sendTransform(_msg)
